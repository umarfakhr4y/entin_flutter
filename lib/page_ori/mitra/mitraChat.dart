...
class mitraChat extends StatefulWidget {
  @override
  mitraChatState createState() => mitraChatState();
}

class mitraChatState extends State<mitraChat> {
  int _count = 1;
              ...
              GestureDetector(
                onTap: () {
                  Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                    builder: (context) => mitraNotif(), maintainState: false));
                },
                child: SizedBox(
                  height: displayHeight(context) * 0.15,
