...
//
//     final dataOrderMitraComplete = dataOrderMitraCompleteFromJson(jsonString);

import 'dart:convert';

DataOrderMitraComplete dataOrderMitraCompleteFromJson(String str) => DataOrderMitraComplete.fromJson(json.decode(str));

String dataOrderMitraCompleteToJson(DataOrderMitraComplete data) => json.encode(data.toJson());

class DataOrderMitraComplete {
    List<User> user;

    DataOrderMitraComplete({
        required this.user,
    });

    factory DataOrderMitraComplete.fromJson(Map<String, dynamic> json) => DataOrderMitraComplete(
