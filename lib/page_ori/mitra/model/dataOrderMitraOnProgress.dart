...
//
//     final dataOrderMitraOnProgress = dataOrderMitraOnProgressFromJson(jsonString);

import 'dart:convert';

DataOrderMitraOnProgress dataOrderMitraOnProgressFromJson(String str) => DataOrderMitraOnProgress.fromJson(json.decode(str));

String dataOrderMitraOnProgressToJson(DataOrderMitraOnProgress data) => json.encode(data.toJson());

class DataOrderMitraOnProgress {
    List<User> user;
    ...
    factory DataOrderMitraOnProgress.fromJson(Map<String, dynamic> json) => DataOrderMitraOnProgress(
