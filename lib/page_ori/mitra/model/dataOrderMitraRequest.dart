...
//
//     final dataOrderMitraRequest = dataOrderMitraRequestFromJson(jsonString);

import 'dart:convert';

DataOrderMitraRequest dataOrderMitraRequestFromJson(String str) => DataOrderMitraRequest.fromJson(json.decode(str));

String dataOrderMitraRequestToJson(DataOrderMitraRequest data) => json.encode(data.toJson());

class DataOrderMitraRequest {
    List<User> user;

    DataOrderMitraRequest({
        required this.user,
    });

    factory DataOrderMitraRequest.fromJson(Map<String, dynamic> json) => DataOrderMitraRequest(
